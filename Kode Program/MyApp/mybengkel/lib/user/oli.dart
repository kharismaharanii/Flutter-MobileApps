...
class Oli extends StatefulWidget {
  @override
  OliState createState() => OliState();
}

class OliState extends State<Oli> {
  final String url =
      'http://10.0.2.2:8080/myapp/mybengkel/lib/koneksi/user/viewOli.php';
  List data = [];
