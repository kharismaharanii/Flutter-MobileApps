...
class Aksesoris extends StatefulWidget {
  @override
  AksesorisState createState() => AksesorisState();
}

class AksesorisState extends State<Aksesoris> {
  final String url =
      'http://10.0.2.2:8080/myapp/mybengkel/lib/koneksi/user/viewAksesoris.php';
  List data = [];
