...
class detailservice extends StatefulWidget {
  int index;
  List data = [];
  detailservice({required this.index, required this.data});
  @override
...
class _detailserviceState extends State<detailservice> {
  deleteService() {
    var url =
        "http://10.0.2.2:8080/myapp/mybengkel/lib/koneksi/admin/deleteservice.php";
            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text(
                    widget.data[widget.index]['haritanggal'],
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                  ),
                  Text(
                    widget.data[widget.index]['tipesepeda'],
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                  ),
                  Padding(
                    padding:
